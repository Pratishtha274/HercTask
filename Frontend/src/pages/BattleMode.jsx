...
//     useEffect(() => {
//         axios.post("/api/battles/start", { player1: "User1", player2: "User2", category: "General" })
//             .then(res => setBattle(res.data.battle))
//             .catch(err => console.log(err));
//     }, []);

//     const submitAnswer = async () => {
//         await axios.put(`/api/battles/${battle._id}/answer`, {
//             playerId: battle.currentTurn,
//             flashcardId: battle.flashcards[0]._id,
//             userAnswer: answer
//         });
...
//     if (!battle) return <p className="text-center mt-10">Loading battle...</p>;

//     return (
//         <div className="text-center mt-10">
//             <h2 className="text-xl font-bold">Flashcard Battle Mode</h2>

//             <p className="mt-4">{battle.players[0]} vs {battle.players[1]}</p>

//             <div className="mt-6 p-6 bg-gray-100 dark:bg-gray-800 rounded-lg shadow-md">
//                 <h3 className="text-lg">{battle.flashcards[0].question}</h3>
...
//                 <button onClick={submitAnswer} className="mt-2 bg-blue-500 text-white px-4 py-2 rounded">
//                     Submit Answer
//                 </button>
//             </div>
//         </div>
